export const Abilities: import('../../../sim/dex-abilities').ModdedAbilityDataTable = {
	...
	//Damp: includes new explosive moves (Burning Will, Electroblast, Pollen Burst, Seek and Destroy)
	damp: {
		inherit: true,
		onAnyTryMove(target, source, effect) {
			if (['burningwill', 'electroblast', 'explosion', 'mindblown', 'mistyexplosion', 'pollenburst', 'seekanddestroy', 'selfdestruct'].includes(effect.id)) {
